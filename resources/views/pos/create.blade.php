...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <span class="badge bg-light text-dark">PDV unificado</span>
    </div>
</div>
...
<div class="alert alert-primary d-flex align-items-center gap-2 mb-4">
    ...
    <div>
        <div class="fw-semibold">Importe itens diretamente de uma Ordem de Serviço aprovada.</div>
        <small class="text-muted">Só usuários com a permissão <code>pdv.invoice_os</code> visualizam a busca de OS.</small>
    </div>
</div>
...
<form method="POST" action="{{ route('pos.store') }}" class="needs-validation" novalidate>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-9 d-flex align-items-end justify-content-end gap-2">
            <input type="search" class="form-control w-auto" placeholder="Buscar itens" aria-label="Buscar item">
