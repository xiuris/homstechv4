...
<div class="row g-3">
    ...
    <div class="col-md-3">
        <label class="form-label" for="duration_minutes">Duração (min)</label>
        <input type="number" class="form-control" id="duration_minutes" name="duration_minutes" value="{{ old('duration_minutes', $service->duration_minutes) }}" min="0">
    </div>
    <div class="col-md-4">
