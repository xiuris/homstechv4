...
- **Descontos no PDV**: os descontos exigem a permissão `apply sale discount` e respeitam o limite percentual configurado por usuário (`discount_limit_percent`), garantindo que vendedores só apliquem abatimentos dentro da política comercial.
