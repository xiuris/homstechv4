...
class PosController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        if ($validated['mode'] === 'sale') {
            $this->processPayments($sale, $validated['payments'] ?? [['method' => 'cash', 'amount' => $total]]);
    ...
    protected function processPayments(Sale $sale, array $payments): void
    {
